...
{
    class BlackMage : PlayerCharacter
    {
        /*
        // Initial attributes
        const int INITIAL_HP = , INITIAL_MP = ,
        ...
        const int IPC_HP = , IPC_MP = ,
            IPC_ATK = , IPC_DEF = , IPC_INT = , IPC_AGI = ,
            IPC_ACC = , IPC_CRT = , IPC_PRE = , IPC_MGD = ;
        ...
        const double PCI_HP = , PCI_MP = ,
            PCI_ATK = , PCI_DEF = , PCI_INT = , PCI_AGI = ,
            PCI_ACC = , PCI_CRT = , PCI_PRE = , PCI_MGD = ;
        ...
        const int IPSG_HP = , IPSG_MP = ,
            IPSG_ATK = , IPSG_DEF = , IPSG_INT = , IPSG_AGI = ,
            IPSG_ACC = , IPSG_CRT = , IPSG_PRE = , IPSG_MGD = ;
        ...
        const double PSGI_HP = 0.0, PSGI_MP = ,
